...
<br>
По условия сервиса разрешено хранить изображения до 2 Мб. Среднее количество изображений объявления - 1. При 30 000 000 объявлений получаем 30 000 000 * 2 Мб = 28.61 Тб.
